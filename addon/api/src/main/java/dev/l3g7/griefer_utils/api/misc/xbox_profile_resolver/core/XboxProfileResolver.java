...
import dev.l3g7.griefer_utils.api.misc.xbox_profile_resolver.token_providers.LabyModTokenProvider;
import dev.l3g7.griefer_utils.api.misc.xbox_profile_resolver.token_providers.MinecraftTokenProvider;
import dev.l3g7.griefer_utils.api.misc.xbox_profile_resolver.token_providers.MultiMCTokenProvider;
import dev.l3g7.griefer_utils.api.misc.xbox_profile_resolver.token_providers.TokenProvider;
import dev.l3g7.griefer_utils.api.misc.xbox_profile_resolver.util.DateTime;
import dev.l3g7.griefer_utils.api.misc.xbox_profile_resolver.util.Requests;
...
import static dev.l3g7.griefer_utils.api.misc.xbox_profile_resolver.util.Util.strMap;

public class XboxProfileResolver {

	private static boolean available = false;

	private static final Set<Long> requestSendTimes = new HashSet<>();
