...
public class Mapper {
	...
	public static void loadMappings(Path assetsDir, Mapping targetMapping, boolean registerTransformer) {
		MappingLoader.loadMappings(assetsDir, targetMapping, registerTransformer);
	}
