...
public class CustomGuiChatFilter extends GuiChatCustom {
	...
	protected void mouseClicked(int mouseX, int mouseY, int mouseButton) {
		...
		scrollbar.mouseAction(mouseX, mouseY, EnumMouseAction.CLICKED);
	...
	protected void mouseClickMove(int mouseX, int mouseY, int clickedMouseButton, long timeSinceLastClick) {
		scrollbar.mouseAction(mouseX, mouseY, EnumMouseAction.DRAGGING);
	...
	protected void mouseReleased(int mouseX, int mouseY, int mouseButton) {
		...
		sliderDrag = -1;
		scrollbar.mouseAction(mouseX, mouseY, EnumMouseAction.RELEASED);
