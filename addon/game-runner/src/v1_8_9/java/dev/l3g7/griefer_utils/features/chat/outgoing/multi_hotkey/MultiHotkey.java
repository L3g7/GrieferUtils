...
package dev.l3g7.griefer_utils.features.chat.outgoing.multi_hotkey;
...
public class MultiHotkey extends Feature {
	...
	public void onKeyPress(KeyInputEvent event) {
		...
		for (HotkeyConfig hotkey : entries.get()) {
			...
			String command = hotkey.commands.get().get(hotkey.amountsTriggered %= hotkey.commands.get().size()).get();
