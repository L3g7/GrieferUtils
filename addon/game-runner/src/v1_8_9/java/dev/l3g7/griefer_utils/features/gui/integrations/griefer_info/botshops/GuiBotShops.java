...
package dev.l3g7.griefer_utils.features.gui.integrations.griefer_info.botshops;
...
import dev.l3g7.griefer_utils.features.gui.integrations.griefer_info.GuiGrieferInfo;
...
public class GuiBotShops extends GuiSearchable<BotShop> {
	...
	private void addFilters(GuiBigChest chest) {
		...
		TextureItem textureItem = new TextureItem("high_res/wallets/ingoing" + (filteringForBuying ? "" : "_gray"), (filteringForBuying ? "§f" : "§7") + "Ankauf", "§8Klicke, um Umzuschalten");
		...
		textureItem = new TextureItem("high_res/wallets/outgoing" + (filteringForSelling ? "" : "_gray"), (filteringForSelling ? "§f" : "§7") + "Verkauf", "§8Klicke, um Umzuschalten");
