...
public enum Category implements BSFSearchable {
	...
	ICE(new BSFName("s", "Eis", "Eis-Biome"), new Color(0xB4DCDC), Blocks.packed_ice, Biome.FROZEN_OCEAN, Biome.ICE_SPIKES),
	...
	ALL(null, null, null, Biome.OCEAN, Category.PLAINS, Category.ICE, Biome.DESERT, Category.FOREST, Category.MOUNTAINS, Category.TAIGA, Biome.SWAMP, Biome.MUSHROOM_FIELDS, Category.BEACH, Biome.JUNGLE, Category.SAVANNA, Category.BADLANDS),
