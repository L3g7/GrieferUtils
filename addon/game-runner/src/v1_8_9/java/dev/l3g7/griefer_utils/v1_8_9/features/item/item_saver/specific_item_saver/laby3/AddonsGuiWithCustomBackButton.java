...
package dev.l3g7.griefer_utils.v1_8_9.features.item.item_saver.specific_item_saver.laby3;
...
public class AddonsGuiWithCustomBackButton extends LabyModAddonsGui {
	...
	protected void actionPerformed(GuiButton button) {
		...
		try {
			...
			throw new RuntimeException(e); // OvErRidDeN mEtHoD dOeS nOt ThRoW IoExCePtIoN stfu it does
		}
	}
