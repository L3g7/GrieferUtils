...
import static dev.l3g7.griefer_utils.v1_8_9.util.render.GlEngine.pos;
import static dev.l3g7.griefer_utils.v1_8_9.util.render.GlEngine.*;
...
public class Trajectories extends Feature {
	...
	public void onRender(RenderWorldLastEvent event) {
		...
		while (!hasLanded && pos.y > 0.0D) {
			...
			// Draw trail
			if (mode.get() == TrajectoryMode.TRAIL)
