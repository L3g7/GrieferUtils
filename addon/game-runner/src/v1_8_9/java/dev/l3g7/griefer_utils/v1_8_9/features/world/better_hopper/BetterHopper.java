...
public class BetterHopper extends Feature {
	...
	private final SwitchSetting fillBoxes = SwitchSetting.create()
	...
	private final NumberSetting displayTime = NumberSetting.create()
		.name("Anzeigedauer")
		.description("Wie lange die optische Anzeige aktiv bleiben soll, in Sekunden.")
		.icon("hourglass")
		.defaultValue(10);

	private final SwitchSetting betterVisualisation = SwitchSetting.create()
	...
	private final SwitchSetting showRange = SwitchSetting.create()
		.name("Trichterreichweite anzeigen")
		.description("Zeigt die Trichterreichweite an.")
		.icon("ruler");

	private final SwitchSetting showSourceHopper = SwitchSetting.create()
