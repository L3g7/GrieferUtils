...
public class Constants {
	...
	public static Class<?> SCHEMATICA_CLIENT_PROXY = null;
	...
	static {
		...
		OPTIFINE = hasOptifine;
	}

	@OnEnable // Has to be set later, otherwise schematica fails to load
	private static void onEnable() {
		try {
			SCHEMATICA_CLIENT_PROXY = Class.forName("com.github.lunatrius.schematica.proxy.ClientProxy");
