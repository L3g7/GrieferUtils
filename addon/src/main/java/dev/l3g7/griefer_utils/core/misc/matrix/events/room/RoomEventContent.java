...
public abstract class RoomEventContent extends EventContent {

	@Override
	public void handle(Session session) {
		throw new UnsupportedOperationException("Room event " + getClass() + " handled directly!");
	}

	public abstract void handle(Session session, Room room);
