...
@Event(key = "m.room_key")
public class RoomKeyEvent extends RoomEventContent {

	public final String algorithm = "m.megolm.v1.aes-sha2";
	...
	public RoomKeyEvent(String roomId, String sessionId, String sessionKey) {
		this.roomId = roomId;
