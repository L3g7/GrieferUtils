...
@Event(key = "m.room.encrypted", asContentType = false)
public class RoomEncryptedEvent extends RoomEventContent {

	public String sender;
	private MegolmEventContent content;

	@Override
	public void handle(Session session, Room room) {
		if (!content.algorithm.equals("m.megolm.v1.aes-sha2") && room != null)
			return;

		// TODO use event
	}

	private static class MegolmEventContent {
