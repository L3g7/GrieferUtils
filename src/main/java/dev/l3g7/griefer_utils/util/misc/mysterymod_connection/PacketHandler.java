...
import dev.l3g7.griefer_utils.util.misc.mysterymod_connection.packets.auth.*;
import dev.l3g7.griefer_utils.util.misc.mysterymod_connection.packets.keep_alive.KeepAliveACKPacket;
import dev.l3g7.griefer_utils.util.misc.mysterymod_connection.packets.keep_alive.KeepAlivePacket;
import dev.l3g7.griefer_utils.util.misc.mysterymod_connection.util.CryptUtil;
	...
	protected void channelRead0(ChannelHandlerContext ctx, Packet packet) {
		if (packet instanceof KeepAlivePacket)
			...
			try {
				...
				System.out.println("Login using " + session.getProfile() + " " + session.getToken().substring(0, 16) + ".. was invalid!");
			}
		}
